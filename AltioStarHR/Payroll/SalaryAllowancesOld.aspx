<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalaryAllowancesOld.aspx.cs"
    Inherits="AltioStarHR.Payroll.SalaryAllowancesOld" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Salary Heads</title>
            ...
            <table class="teble_bg" style="width: 600px">
                <tbody>
                    <tr>
                        ...
                        <td id="sallowancename" width="200" height="40" class="family">
                        </td>
                    </tr>
                    <tr>
                        <td class="label" width="200" height="40">
                        ...
                        <td id="sallowanceperiod" width="200" height="40" class="family">
                        </td>
                    </tr>
                     <tr>
                        <td class="label" width="200" height="40">
                    ...
                    <tr>
                        ...
                        <td class="field">
                            <input id="isallowance" type="checkbox" />
                    ...
                    <tr>
                        ...
                        <td class="field">
                            ...
                            <span id="spnperc" style="display: none;" class="family">No</span>
                        </td>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        var myGrid = $('#list');
        var Response = SendApplicationRequest('<%=PayrollAppCommands.SALARY_ALLOWANCES%>', '', true, '<%=RequestCommands.PAYROLL_REQUEST%>');
        Response.ResponseObject.colModel = [
   		            ...
   		            { name: 'allowancecode', index: 'allowancecode', width: 100, hidden: true, editable: true },
            ...
            if (id.currentTarget.id == "add") {
                ...
                if (id) {
                    if (ret.isactive == 'True') {
                        ...
                        var Response = SendApplicationRequest("<%=PayrollAppCommands.DEACTIVATE_SALARYALLOWANCE%>", Request, true, '<%=RequestCommands.PAYROLL_REQUEST%>');
                ...
                if (id) {
                    if (ret.isactive == 'False') {
                        ...
                        Request.ID = ID;
                        Request.ChangedBy = $("#hdnEmployeeID").val();
                        var Response = SendApplicationRequest("<%=PayrollAppCommands.ACTIVATE_SALARYALLOWANCE%>", Request, true, '<%=RequestCommands.PAYROLL_REQUEST%>');
                        alert(Response.Message);
                        if (Response.ResponseCommand == 'SUCCESS') {
                            mode = "";
                            var Response = SendApplicationRequest('<%=PayrollAppCommands.INACTIVE_SALARYALLOWANCES%>', '', true, '<%=RequestCommands.PAYROLL_REQUEST%>');
                            if (Response.ResponseObject.datastr == null)
                                jQuery("#list").jqGrid('clearGridData');
                            else {
                                jQuery("#list").jqGrid('setGridParam', Response.ResponseObject);
        ...
        var validator = $("#signupForm").validate({
            ...
            messages: {
                allowancename: {
                    required: "Enter Salary Head"
                    //alphaNumerix: "Invalid Salary Head"
                }
            },
            ...
            submitHandler: function() {
                ...
                var Response = SendApplicationRequest('<%=PayrollAppCommands.UPDATE_SALARYALLOWANCE%>', Request, true, '<%=RequestCommands.PAYROLL_REQUEST%>');                
                if(mode == "edit")
                {
    ...
    function BindGrid(pageNumber) {
        ...
        if (Response.ResponseObject.datastr == null)
            ...
            jQuery("#list").jqGrid('setGridParam', Response.ResponseObject);
            jQuery("#list").jqGrid('setCaption', "Salary Head Details").trigger('reloadGrid');
