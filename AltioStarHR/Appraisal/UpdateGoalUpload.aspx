<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateGoalUpload.aspx.cs" Inherits="AltioStarHR.Appraisal.UpdateGoalUpload" %>
...
<body TargetPage="self">
    <form id="form1" runat="server" action="UpdateGoalUpload.aspx" method="post">
    ...
    <div class="family">
        <table style="width:100%;background-color:#a4cd0f">
            <tr>
                ...
                <td><input type="text" id="datepick" style="width: 80px" readonly="readonly" name="datepick" runat="server" class="family"/></td>
            </tr>
            <tr>
                <td class="label">
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        $(function() {
            ...
            var dat = $("#hdnDate").val().split('/');
            $('#datepick').datepicker("setDate", new Date(dat[2], dat[1] - 1, dat[0]));
        });
        //
        
        //$("#datepick").val($("#hdnDate").val());
    });
