<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeGradeUpload.aspx.cs" Inherits="AltioStarHR.Appraisal.EmployeeGradeUpload" %>
...
<body TargetPage="self">
    <form id="form1" runat="server" action="EmployeeGradeUpload.aspx" method="post">
    <div>
        <div class="header_title" style="width: 360px; margin: 0">
       <span class="family1">Altiostar Employee Performance Review Form</span>
        </div>
        <br />
