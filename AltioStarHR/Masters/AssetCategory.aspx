<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetCategory.aspx.cs" Inherits="AltioStarHR.Masters.AssetCategory" %>
...
<body>
<%--<div style="position:relative; top: 0px; left: 0px; height: 123px;">
    <img alt="" src="Resources/Images/NewImages/inside_pg_header.jpg" style="width:100%;height:70%"/>  
 </div>--%>
<div style="position:relative;width:100%">
  ...
  <%--<strong class="family1 imageheadercolor">Asset Category</strong>--%>
  <strong class="family1 imageheadercolor">Asset Category</strong>
    </div>
</div>
    <div class="dvGrid" id="divassetcategory" style="display:none;width:100%;">
        <form id="signupForm" method="get" action="">
        <fieldset style="width: 97%;margin-left:2%;margin-top:0%">
            <table style="width:100%;background-color:#a4cd0f">
                  <tr>
                        <td style="width:20%;">
                            <label id="lassetcategory" for="assetcategory" class="family">
                                Asset Category</label>
                            <span style="font-size: medium; color: Red">*</span>
                        </td>
                        <td style="width:18%;">
                            <input id="assetcategory" name="assetcategory" type="text" tabindex="1" value="" style="width: 220px;border:1px solid silver"  class="family"/>
                        </td>
                        <td id="sassetcategory" class="family">
                        </td>
                    </tr>
                    <tr>
                        <td style="width:20%">
...
//    $('#box').css('background-image', 'url(Resources/Images/NewImages/dashboard_bg1.gif)');
    ...
    jQuery(document).ready(function() {
        ...
        var Response = SendApplicationRequest('<%=HRAppCommands.GET_ALL_ASSET_DETAILS%>', '', true);

        Response.ResponseObject.colModel = [
            { name: 'id', index: 'id', width: 20, hidden: true, sorttype: "int" },
            { name: 'assetcategories', index: 'assetcategories', width: 100, editable: true },
        ...
        //        Response.ResponseObject.caption = "Asset Category";
        ...
        $("button,input", "#t_list").click(function(id) {
            ...
            if (id.currentTarget.id == "add") {
                ...
                document.getElementById("divassetcategory").style.display = "";
            }
...
//        $("#list").closest(".ui-jqgrid-bdiv").height("auto");
        ...
        var validator = $("#signupForm").validate({
            ...
            messages: {
                assetcategory: {
                    alphaNumerix: "Invalid Asset Category ",
                    required: "Enter Asset Category",
            ...
            submitHandler: function(id) {
                ...
                Request.ID = ID;
                Request.AssetCategories = $("#assetcategory").val();
                ...
                //Request.UpdateBy=1;
                var Response = SendApplicationRequest('<%=HRAppCommands.UPDATE_ASSETCATEGORY%>', Request, true);

                alert(Response.Message);
                if (Response.ResponseCommand == 'SUCCESS') {
                    mode = "SUCCESS";
                    
                     var Response = SendApplicationRequest('<%=HRAppCommands.GET_ALL_ASSET_DETAILS%>', Request, true);
    ...
    function ActivateRow(ROWID) { 
        ...
        var Response = SendApplicationRequest("<%=HRAppCommands.GET_ACTIVE_DEACTIVATE_ASSETCATEGORY%>", Request, true);
        alert(Response.Message);
...
function onCancel() {
    ...
    document.getElementById("divassetcategory").style.display = "none";
}
function fillData() {

    var id = jQuery("#list").jqGrid('getGridParam', 'selrow');
    var ret = jQuery("#list").jqGrid('getRowData', id);
    $("#assetcategory").val(ret.assetcategories);
