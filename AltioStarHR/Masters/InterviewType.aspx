<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InterviewType.aspx.cs" Inherits="AltioStarHR.Masters.WebForm1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Interview Type</title>
...
<div style="position:relative;width: 100%">
  ...
  <strong class="family1 imageheadercolor">Interview Type Details</strong>
    </div>
</div>

    <%--<div class="dvGrid" id="divInterviewType" style="display: none;width: 900px">--%>
      <%--  <form id="signupForm" method="get" action="">
        <fieldset class="teble_bg" style="width: 890px">
            <table>
                  <tr>
                        <td class="label" width="90" height="40">
                            <label id="lIntertype" for="Intertype">
                                InterViewType</label>
                            <span style="font-size: medium; color: Red">*</span>
                        </td>
                        <td class="field" width="90" height="40">
                            <input id="Intertype" name="Intertype" type="text" tabindex="1" value="" style="width: 200px" />
                        </td>
                        <td>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="field" width="90" height="40">
                            <textarea id="description" name="description" style="width: 220px" tabindex="2" maxlength="100"
                ...
                <tr>  
                    <td>
                        <label id="lisactive" for="isactive">
                            Active</label>
                    </td>
                    <td>
        ...
        <div class="dvGrid" id="divInterviewType" style="display: none;width: 100%">
         <form id="signupForm" method="get" action="">
        <fieldset style="width: 97%;margin-left:2%;margin-top:0%">
            <table style="width:100%;background-color:#a4cd0f" >
                  <tr>
                        <td style="width:20%">
                            <label id="lIntertype" for="Intertype" class="family">
                                Interview Type</label>
                            <span style="font-size: medium; color: Red">*</span>
                        </td>
                        <td style="width:18%">
                            <input id="Intertype" name="Intertype" type="text" tabindex="1" value="" style="width: 220px;border:1px solid silver" class="family"/>
                        </td>
                        <td>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width:18%">
                            <textarea id="description" name="description" style="width: 220px;border:1px solid silver" tabindex="2" maxlength="100" class="family"
                                cols="30" rows="3"></textarea>
                        </td>
                        <td>
                        </td>
                ...
                <tr>  
                    ...
                    <td>
                        <input id="isactive" type="checkbox" style="border:1px solid silver" class="family"/>
                    </td>
                    <td class="status" id="sisactive">
                    </td>
                </tr>
    ...
    <div style="margin-left:2%;" id="box">
        <table id="list" style="background:Resources/Images/NewImages/dashboard_bg.gif">
        </table>
        <div id="pager">
        </div>
    </div>
...
//    }).trigger('resize');
    ...
    jQuery(document).ready(function() {
        ...
        var Response = SendApplicationRequest('<%=HRAppCommands.GET_ALL_INTERVIEW_DETAILS%>', '', true);

        Response.ResponseObject.colModel = [
            { name: 'id', index: 'id', width: 20, hidden: true, sorttype: "int" },
            { name: 'interviewtype', index: 'interviewtype', width: 100, editable: true },
        ...
        //        Response.ResponseObject.caption = "InterViewType";
...
//        jQuery("#list").jqGrid('setCaption', "Interview Type Details").trigger('reloadGrid');
        ...
        $("button,input", "#t_list").click(function(id) {
            ...
            if (id.currentTarget.id == "add") {
                ...
                document.getElementById("divInterviewType").style.display = "";
            }
...
//        $(cDiv).hide();
        ...
        var validator = $("#signupForm").validate({
            ...
            messages: {
                Intertype: {
                    alphaNumerix: "Invalid Interview Type Name",
                    required: "Enter Interview Type Name"
                },
                description: {
            ...
            submitHandler: function(id) {
                ...
                Request.ID = ID;
                Request.InterviewType = $("#Intertype").val();
                ...
                //Request.UpdateBy=1;
                var Response = SendApplicationRequest('<%=HRAppCommands.UPDATE_INTERVIEWTYPE%>', Request, true);

                alert(Response.Message);
                if (Response.ResponseCommand == 'SUCCESS') {
                    mode = "SUCCESS";

                    var Response = SendApplicationRequest('<%=HRAppCommands.GET_ALL_INTERVIEW_DETAILS%>', Request, true);
    ...
    function ActivateRow(ROWID) {
        ...
        var Response = SendApplicationRequest("<%=HRAppCommands.GET_ACTIVE_DEACTIVATE_INTERVIEWTYPE%>", Request, true);
        alert(Response.Message);
    ...
    function onCancel() {
        ...
        document.getElementById("divInterviewType").style.display = "none";
    }
    function fillData() {

        var id = jQuery("#list").jqGrid('getGridParam', 'selrow');
        var ret = jQuery("#list").jqGrid('getRowData', id);
        $("#Intertype").val(ret.interviewtype);
