<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetSubCategory.aspx.cs" Inherits="AltioStarHR.Masters.AssetSubCategory" %>
...
<div style="position:relative;width:100%">
  ...
  <strong class="family1 imageheadercolor">Asset SubCategory</strong>
    </div>
</div>
    <div class="dvGrid" id="divassetsubcategory" style="display:none;width:100%;">
        <form id="signupForm" method="get" action="">
        <fieldset style="width: 97%;margin-left:2%;margin-top:0%">
            <table style="width:100%;background-color:#a4cd0f">
                  <tr>
                        <td style="width:20%;">
                            <label id="lassetsub" for="assetsub" class="family">
                                Asset SubCategory</label>
                            <span style="font-size: medium; color: Red">*</span>
                        </td>
                        <td style="width:18%;">
                            <input id="assetsub" name="assetsub" type="text" tabindex="1" value="" style="width: 220px;border:1px solid silver" class="family"/>
                        </td>
                        <td>
                        </td>
                    </tr>
                ...
                <tr>  
                    ...
                    <td>
                        <input id="isactive" type="checkbox" style="border:1px solid silver" />
                    </td>
                ...
                <td></td>
                <td>
                  <input id="signupsubmit" name="Submit" type="submit" class="family" value="Save" class="family"/>
                  <input id="Cancel" name="Cancel" type="button" class="family" value="Cancel" class="family"/>
                </td>
                </tr>
            </table>
           <%-- <table>
...
//    }).trigger('resize');
    ...
    jQuery(document).ready(function() {
        ...
        var Response = SendApplicationRequest('<%=HRAppCommands.GET_ALL_SUB_ASSET_DETAILS%>', '', true);

        Response.ResponseObject.colModel = [
            { name: 'id', index: 'id', width: 20, hidden: true, sorttype: "int" },
            { name: 'assetsubcategory', index: 'assetsubcategory', width: 100, editable: true },
        ...
        //        Response.ResponseObject.caption = "Asset SubCategory";
        ...
        $("button,input", "#t_list").click(function(id) {
            ...
            if (id.currentTarget.id == "add") {
                ...
                document.getElementById("divassetsubcategory").style.display = "";
            }
...
//        $("#list").closest(".ui-jqgrid-bdiv").height("auto");
        ...
        var validator = $("#signupForm").validate({
            ...
            messages: {
                assetsub: {
                    alphaNumerix: "Invalid Asset Subcategory ",
                    required: "Enter Asset Subcategory",
            ...
            submitHandler: function(id) {
                ...
                Request.ID = ID;
                Request.AssetSubCategories = $("#assetsub").val();
                ...
                //Request.UpdateBy=1;
                var Response = SendApplicationRequest('<%=HRAppCommands.UPDATE_ASSETSUBCATEGORY%>', Request, true);

                alert(Response.Message);
                if (Response.ResponseCommand == 'SUCCESS') {
                    mode = "SUCCESS";
                    var Response = SendApplicationRequest('<%=HRAppCommands.GET_ALL_SUB_ASSET_DETAILS%>', Request, true);
  ...
  function ActivateRow(ROWID) { 
        ...
        var Response = SendApplicationRequest("<%=HRAppCommands.GET_ACTIVE_DEACTIVATE_ASSETSUBCATEGORY%>", Request, true);
        alert(Response.Message);
    ...
    function onCancel() {
        ...
        document.getElementById("divassetsubcategory").style.display = "none";
    }
    function fillData() {

        var id = jQuery("#list").jqGrid('getGridParam', 'selrow');
        var ret = jQuery("#list").jqGrid('getRowData', id);
        $("#assetsub").val(ret.assetsubcategory);
