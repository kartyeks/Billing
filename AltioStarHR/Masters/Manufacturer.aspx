<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manufacturer.aspx.cs" Inherits="AltioStarHR.Masters.Manufacturer" %>
...
<div style="position:relative;width:100%">
  ...
  <strong class="family1 imageheadercolor">Manufacturer</strong>
    </div>
</div>
<div class="dvGrid" id="divManufacturer" style="display:none;width:100%;">
        <form id="signupForm" method="get" action="">
        <fieldset style="width: 97%;margin-left:2%;margin-top:0%">
       <table style="width:100%;background-color:#a4cd0f">
                  <tr>
                        <td  style="width:20%;">
                            <label id="lmanufacturer" for="manufacturer" style="" class="family">
                               Manufacturer Name</label>
                            <span style="font-size: medium; color: Red">*</span>
                        </td>
                        <td style="width:18%;">
                            <input id="manufacturer" class="teble_bg family " name="manufacturer" type="text" tabindex="1" value="" style="width: 220px;border:1px solid silver" />
                        </td>
                        <td>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td  style="width:18%" >
                            <textarea id="description" class="display family" name="description" style="width: 220px;border:1px solid silver" tabindex="2" maxlength="100" 
                ...
                <tr>  
                    ...
                    <td class="status family" id="sisactive" >
                    </td>
                </tr>
                <tr>
                    <td>
...
//        }).trigger('resize');
    ...
    jQuery(document).ready(function() {
        ...
        var Response = SendApplicationRequest('<%=HRAppCommands.GET_ALL_MANUFACTURER_DETAILS%>', '', true);

        Response.ResponseObject.colModel = [
            { name: 'id', index: 'id', width: 20, hidden: true, sorttype: "int" },
            { name: 'manufacturername', index: 'manufacturername', width: 100, editable: true },
        ...
        //        Response.ResponseObject.caption = "Manufacturer";
        ...
        $("button ,input", "#t_list").click(function(id) {
            ...
            if (id.currentTarget.id == "add") {
                ...
                document.getElementById("divManufacturer").style.display = "";
            }
...
//$("#list").closest(".ui-jqgrid-bdiv").height("auto");
        ...
        var validator = $("#signupForm").validate({
            ...
            messages: {
                manufacturer: {
                    alphaNumerix: "Invalid Manufacturer Name",
            ...
            submitHandler: function(id) {
                ...
                Request.ID = ID;
                Request.ManufacturerName = $("#manufacturer").val();
                ...
                //Request.UpdateBy=1;
                var Response = SendApplicationRequest('<%=HRAppCommands.UPDATE_MANUFACTURER%>', Request, true);
                ...
                if (Response.ResponseCommand == 'SUCCESS') {
                    ...
                    var Response = SendApplicationRequest('<%=HRAppCommands.GET_ALL_MANUFACTURER_DETAILS%>', Request, true);
    ...
    function ActivateRow(ROWID) {
        ...
        var Response = SendApplicationRequest("<%=HRAppCommands.GET_ACTIVE_DEACTIVATE_MANUFACTURER%>", Request, true);
        alert(Response.Message);
...
function onCancel() {
    ...
    document.getElementById("divManufacturer").style.display = "none";
}
function fillData() {

    var id = jQuery("#list").jqGrid('getGridParam', 'selrow');
    var ret = jQuery("#list").jqGrid('getRowData', id);
    $("#manufacturer").val(ret.manufacturername);
