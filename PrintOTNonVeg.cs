    ...
    public class PrintOTNonVeg
    {
        ...
        public void print(KOTBillPrintTableList tList)
        {
            ...
            if (tList._PrintTables.Length != 0)
            {
                ...
                {
                    if (tList._PrintTables[i]._GroupID == 3)
                    {
                ...
                if (c != 0)
                {
                    ...
                    pp.Document = pdoc;
                    if (IS91.Services.Common.GetAppSetting("NonVegPrinter") != "")
                    {
                        pdoc.PrinterSettings.PrinterName = IS91.Services.Common.GetAppSetting("NonVegPrinter");
                    }
                   // pp.ShowDialog();
                    pdoc.Print();
                    //Added by Archana
        ...
        public void printUpdated(KOTBillPrintTableList tList)
        {
            ...
            if (tList._PrintTables.Length != 0)
            {
                ...
                if (a != 0)
                {
                    pdoc.PrintPage += new PrintPageEventHandler(pdoc_PrintPage_Updaed_NonVeg);
                    PrintPreviewDialog pp = new PrintPreviewDialog();
                    pp.Document = pdoc;
                    if (IS91.Services.Common.GetAppSetting("NonVegPrinter") != "")
                    {
        ...
        void pdoc_PrintPage_Updaed_NonVeg(object sender, PrintPageEventArgs e)
        {
            Graphics graphics = e.Graphics;
            Font font = new Font("Courier New", 8, FontStyle.Bold);
            float fontHeight = font.GetHeight();
