...
namespace HRManager.DTO
{
      ...
      [Serializable()]
		public class Master_CompanyBranches : TableMetadata
		{

                   public enum Master_CompanyBranchesFields
                   {
                      ID,
                      CompanyCode,
                      CompanyName,
		    	...
		    	public Master_CompanyBranches()
			    {
                    ...
                    _fields[3] = new DatabaseField(DbType.Int32,"CountryID",false,false,null);
                    ...
                    _fields[8] = new DatabaseField(DbType.DateTime,"ModifiedDate",false,false,null);
                        ...
                        this.currentTableName = "Master_CompanyBranches";
          ...
          public Master_CompanyBranches Clone()
          {
                 return this.Clone<Master_CompanyBranches>();
          }
