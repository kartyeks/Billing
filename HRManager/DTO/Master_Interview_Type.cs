...
namespace HRManager.DTO
{
      ...
      [Serializable()]
		public class Master_Interview_Type : TableMetadata
		{

                   public enum Master_Interview_TypeFields
                   {
                      ID,
                      InterviewType,
                      Description,
		    	...
		    	public Master_Interview_Type()
			    {
					    _fields = new DatabaseField[8];
                    _fields[0] = new DatabaseField(DbType.Int32,"ID",true,true,null);
                    _fields[1] = new DatabaseField(DbType.String,"InterviewType",false,false,null);
                    ...
                    _fields[7] = new DatabaseField(DbType.DateTime,"ModifiedDate",false,false,null);
                        ...
                        this.currentTableName = "Master_Interview_Type";
          ...
          public Master_Interview_Type Clone()
          {
                 return this.Clone<Master_Interview_Type>();
          }
...
public System.String InterviewType
{
    get
    {
         object result = this.GetField("InterviewType").fieldValue; 
         return (result != null) ? result.ToString() : String.Empty;
    }

    set
    {
          this.SetFieldValue("InterviewType", value);
    }
}
