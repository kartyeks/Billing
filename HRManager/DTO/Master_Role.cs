...
namespace HRManager.DTO
{
      ...
      [Serializable()]
		public class Master_Role : TableMetadata
		{

                   public enum Master_RoleFields
                   {
                      ID,
                      Role,
                      Description,
		    	...
		    	public Master_Role()
			    {
                    ...
                    _fields[1] = new DatabaseField(DbType.String,"Role",false,false,null);
                    ...
                    _fields[8] = new DatabaseField(DbType.String,"Menu",false,false,null);
 
                        this.currentTableName = "Master_Role";
          ...
          public Master_Role Clone()
          {
                 return this.Clone<Master_Role>();
          }
...
public System.String Role
{
    get
    {
          object result = this.GetField("Role").fieldValue;
...
public System.String Menu
{
    get
    {
          object result = this.GetField("Menu").fieldValue;
          return (result != null) ? result.ToString() : null;
    }

    set
    {
          this.SetFieldValue("Menu", value);
    }
}
