...
namespace HRManager.DTO
{
      ...
      [Serializable()]
		public class Master_AdvanceType : TableMetadata
		{

                   public enum Master_AdvanceTypeFields
                   {
                      ID,
                      AdvanceType,
                      IsActive,
		    	...
		    	public Master_AdvanceType()
			    {
					    _fields = new DatabaseField[7];
                    _fields[0] = new DatabaseField(DbType.Int32,"ID",true,true,null);
                    _fields[1] = new DatabaseField(DbType.String,"AdvanceType",false,false,null);
                    ...
                    _fields[6] = new DatabaseField(DbType.DateTime,"ModifiedDate",false,false,null);
                        ...
                        this.currentTableName = "Master_AdvanceType";
          ...
          public Master_AdvanceType Clone()
          {
                 return this.Clone<Master_AdvanceType>();
          }
...
public System.String AdvanceType
{
    get
    {
         object result = this.GetField("AdvanceType").fieldValue; 
         return (result != null) ? result.ToString() : String.Empty;
    }

    set
    {
          this.SetFieldValue("AdvanceType", value);
    }
}
