...
namespace HRManager.DTO
{
      ...
      [Serializable()]
		public class Master_mProjectType : TableMetadata
		{

                   public enum Master_mProjectTypeFields
                   {
                      ID,
                      ProjectCode,
                      ProjectType,
		    	...
		    	public Master_mProjectType()
			    {
					    _fields = new DatabaseField[8];
                    _fields[0] = new DatabaseField(DbType.Int32,"ID",true,true,null);
                    _fields[1] = new DatabaseField(DbType.String,"ProjectCode",false,false,null);
                    _fields[2] = new DatabaseField(DbType.String,"ProjectType",false,false,null);
                    ...
                    _fields[7] = new DatabaseField(DbType.DateTime,"ModifiedDate",false,false,null);
                        ...
                        this.currentTableName = "Master_mProjectType";
          ...
          public Master_mProjectType Clone()
          {
                 return this.Clone<Master_mProjectType>();
          }
