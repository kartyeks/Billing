...
namespace HRManager.DTO
{
      ...
      [Serializable()]
		public class Master_AssetSubCategory : TableMetadata
		{

                   public enum Master_AssetSubCategoryFields
                   {
                      ID,
                      AssetSubCategory,
                      Description,
		    	...
		    	public Master_AssetSubCategory()
			    {
					    _fields = new DatabaseField[8];
                    _fields[0] = new DatabaseField(DbType.Int32,"ID",true,true,null);
                    _fields[1] = new DatabaseField(DbType.String,"AssetSubCategory",false,false,null);
                    ...
                    _fields[7] = new DatabaseField(DbType.DateTime,"ModifiedDate",false,false,null);
                        ...
                        this.currentTableName = "Master_AssetSubCategory";
          ...
          public Master_AssetSubCategory Clone()
          {
                 return this.Clone<Master_AssetSubCategory>();
          }
...
public System.String AssetSubCategory
{
    get
    {
         object result = this.GetField("AssetSubCategory").fieldValue; 
         return (result != null) ? result.ToString() : String.Empty;
    }

    set
    {
          this.SetFieldValue("AssetSubCategory", value);
    }
}
