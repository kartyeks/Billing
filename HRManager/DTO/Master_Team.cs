...
namespace HRManager.DTO
{
      ...
      [Serializable()]
		public class Master_Team : TableMetadata
		{

                   public enum Master_TeamFields
                   {
                      ID,
                      TeamName,
                      ManagerID,
		    	...
		    	public Master_Team()
			    {
                    ...
                    _fields[1] = new DatabaseField(DbType.String,"TeamName",false,false,null);
                    _fields[2] = new DatabaseField(DbType.Int32,"ManagerID",false,false,null);
                    ...
                    _fields[7] = new DatabaseField(DbType.DateTime,"ModifiedDate",false,false,null);
                        ...
                        this.currentTableName = "Master_Team";
          ...
          public Master_Team Clone()
          {
                 return this.Clone<Master_Team>();
          }
...
public System.String TeamName
{
    get
    {
          object result = this.GetField("TeamName").fieldValue;
          return (result != null) ? result.ToString() : null;
    }

    set
    {
          this.SetFieldValue("TeamName", value);
    }
}
